...
- **Forage first** - any project **Bee Planet Connection** praises puts nectar and pollen on the ground before it puts hives on a roof.  
- **Wild bees count** - if an initiative boosts honeybees but leaves wild pollinators worse off, it"s a fail.  
...
### House style cheat-sheet used in this article

- **Tone** - British, bright, conversational, confident.  
- **Dashes** - short - not long or spaced.  
- **Apostrophes** - use " as instructed here.  
- **Spelling** - British English.  
- **Sentences** - energetic, varied length, active voice.  
- **Jargon** - minimal; explain in plain English.  
- **Evidence** - woven into narrative, no footnote soup.  
- **Ethos** - fair to farmers and beekeepers while firm on pollinator health.  
- **Structure** - clear subheads, tight paragraphs, punchy closes.  
- **Calls to action** - practical, specific, neighbourly.
